...
// Metadata for attack bonus
type AttackBonusMetadata = {
    effectType: 'attackBonus';
    value: number;
    condition?: string; // e.g., "ranged weapon", "with a specific weapon type"
};

// Metadata for damage bonus
type DamageBonusMetadata = {
    effectType: 'damageBonus';
    value: number;
    condition?: string; // e.g., "wielding melee weapon in one hand and no other weapon"
};
...
export type FeatureEffectMetadata =
  ...
  | AttackBonusMetadata // Added AttackBonus
  | DamageBonusMetadata; // Added DamageBonus
// | SpeedBonusMetadata
...
export interface Monster {
  ...
  actions?: Array<{ name: string; description: string; attackBonus?: number; damageDice?: string; damageBonus?: number; damageType?: string; }>; // Added damageType
}
