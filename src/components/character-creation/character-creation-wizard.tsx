...
<changes>
  <change>
    <file>src/components/character-creation/character-creation-wizard.tsx</file>
    <description>Fix import path for getBackgroundFeatures. Import it from feature-service.ts instead of dnd-api.ts.</description>
    <content><![CDATA[
'use client';
