...
import type { CharacterClass, CharacterRace, Feature, CharacterLevel, EquipmentItem, HitPoints, BackgroundInfo, SourcePack, Spell } from '@/lib/types';
import { LoggingService } from '@/nestjs/logging/logging.service';
import { FeaturesService } from '@/nestjs/features/features.service'; // Import FeaturesService
